                    ...
                    <section id='projets' className='w-full pb-[-50px] bg-[url("/bg1.svg")] bg-cover bg-right lg:bg-center overflow-hidden'>
                        <div className='max-w-screen-lg mx-auto flex flex-col'>
                            ...
                            <div className="grid grid-flow-row-dense grid-cols-1 lg:grid-cols-2 gap-4 my-10">
                                <div className="bg-[url('/projets/woa-1.png')] bg-cover h-[300px] bg-zinc-500 rounded-md p-2 relative hover:scale-105 transition-transform ease-in-out duration-300">
                                    <div className='absolute left-0 bottom-0 mb-4 ml-2 text-white font-bold bg-light-dark rounded-md p-2 mt-2'>Walk of Art</div>
                                </div>
                                <div className="bg-[url('/projets/swoaper.png')] bg-cover h-[300px] bg-zinc-500 rounded-md p-2 relative hover:scale-105 transition-transform ease-in-out duration-300">
                                    <div className='absolute left-0 bottom-0 mb-4 ml-2 text-white font-bold bg-light-dark rounded-md p-2 mt-2'>Swoaper</div>
                                </div>
                                <div className="bg-[url('/projets/portfolio-2023.png')] bg-cover h-[300px] bg-zinc-500 rounded-md p-2 relative hover:scale-105 transition-transform ease-in-out duration-300">
                                ...
                                <div className="bg-[url('/projets/company-finder.png')] bg-cover h-[300px] bg-zinc-500 rounded-md p-2 relative hover:scale-105 transition-transform ease-in-out duration-300">
                                ...
                                <div className="bg-[url('/projets/carpool-1.png')] bg-cover h-[300px] bg-zinc-500 rounded-md p-2 relative hover:scale-105 transition-transform ease-in-out duration-300">
                                    <div className='absolute left-0 bottom-0 mb-4 ml-2 text-white font-bold bg-light-dark rounded-md p-2 mt-2'>Carpool</div>
                                </div>
                                <div className="bg-[url('/projets/outil-cr-vlabs.png')] bg-cover h-[300px] bg-zinc-500 rounded-md p-2 relative hover:scale-105 transition-transform ease-in-out duration-300">
