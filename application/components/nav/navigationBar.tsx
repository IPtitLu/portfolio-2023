...
const navigation = [
    { name: 'A propos', href: '/', class: 'ml-4 mr-2 text-xl hover:text-orange hover:border-b-2 border-0 border-orange', activeClass: 'ml-4 mr-2 text-xl border-b-2 border-orange hover:text-orange' },
